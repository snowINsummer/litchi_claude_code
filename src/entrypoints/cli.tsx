// Define MACRO for build-time version
declare const MACRO: { VERSION: string };

// Type assertion for runtime
const MACRO_VERSION = '2.1.88';

// Version helper
function getVersion(): string {
  return typeof MACRO !== 'undefined' ? MACRO.VERSION : MACRO_VERSION;
}
...
async function main(): Promise<void> {
  ...
  if (args.length === 1 && (args[0] === '--version' || args[0] === '-v' || args[0] === '-V')) {
    ...
    console.log(`${getVersion()} (Claude Code)`);
    return;
  }
